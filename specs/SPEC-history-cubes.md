...
2. The Cubes grid has a solid primary-blue outer frame positioned outside the cube faces with enough clearance that animated cubes are not cropped; the frame uses no gradient.
