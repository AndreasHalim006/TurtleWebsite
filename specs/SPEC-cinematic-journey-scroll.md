...
9. **Outro menu framing**:
   ...
   - Only after the outro timeline tween truly completes, DrawSVG dash-array and dash-offset styles are cleared from every car path so no final easing update can restore them and chop the wireframe.
