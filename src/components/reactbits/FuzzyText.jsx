  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      if (typeof fontSize === 'number') {
        ...
        numericFontSize = parseFloat(computedSize) || 70;
        document.body.removeChild(temp);
      }

      // Priority: textProp > children
      const text = textProp || React.Children.toArray(children)
      ...
      const textBoundingWidth = Math.ceil(letterSpacing !== 0 ? totalWidth : actualLeft + actualRight) || 1;
      const tightHeight = Math.ceil(actualAscent + actualDescent) || numericFontSize;
